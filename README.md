...
- Cabin: 687 missing values (77%) - converted to Has_Cabin flag and Deck letter, then dropped
- Engineered features: Title, FamilySize, IsAlone, AgeGroup

## Files
- titanic_eda.ipynb - full analysis notebook
- data/titanic_raw.csv - original dataset
...
## Conclusion
Survival was driven primarily by gender, passenger class, and age, consistent with a "women and children first" evacuation policy that also favored wealthier passengers. A natural next step would be training a classification model using these features.
